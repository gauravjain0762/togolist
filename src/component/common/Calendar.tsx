    ...
    <View style={styles.container}>
      ...
      <View style={styles.weekRow}>
       ...
       <FlatList
        ...
        scrollEnabled={false}
        renderItem={({ item }) => {
          const isSelected = selectedDates.some((d) => d.isSame(item.date, 'date'));
          return (
            <TouchableOpacity
              style={[styles.dayCell, !item.isCurrentMonth && styles.selectedDayCell,isSelected && styles.selectedDayCell1]}
