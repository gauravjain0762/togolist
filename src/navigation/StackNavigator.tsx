...
const StackNavigator: FC = () => {
  ...
  return (
    <Stack.Navigator
      ...
      screenOptions={{
        gestureDirection: 'horizontal', // Enables the vertical swipe gesture
        cardStyleInterpolator: CardStyleInterpolators.forHorizontalIOS, // This is the key for vertical animation
      }}>
      <Stack.Screen
